...
func (_m *MockStorage) Download(ctx context.Context, key string) (*storage.DownloadResult, error) {
	ret := _m.Called(ctx, key)
...
func (_c *MockStorage_Download_Call) Return(_a0 *storage.DownloadResult, _a1 error) *MockStorage_Download_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStorage_Download_Call) RunAndReturn(run func(context.Context, string) (*storage.DownloadResult, error)) *MockStorage_Download_Call {
	_c.Call.Return(run)
	return _c
}

// Upload provides a mock function with given fields: ctx, key, body, size, contentType
func (_m *MockStorage) Upload(ctx context.Context, key string, body io.Reader, size int64, contentType string) error {
...
//   - size int64
//   - contentType string
func (_e *MockStorage_Expecter) Upload(ctx interface{}, key interface{}, body interface{}, size interface{}, contentType interface{}) *MockStorage_Upload_Call {
	return &MockStorage_Upload_Call{Call: _e.mock.On("Upload", ctx, key, body, size, contentType)}
}

func (_c *MockStorage_Upload_Call) Run(run func(ctx context.Context, key string, body io.Reader, size int64, contentType string)) *MockStorage_Upload_Call {
	_c.Call.Run(func(args mock.Arguments) {
